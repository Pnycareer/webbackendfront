    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button type="button" variant="ghost" size="sm" className="h-9 w-9 p-0" onClick={onClick}>
    ...
    <Card className="w-full border rounded-2xl shadow-sm">
      <CardHeader className="py-2">
        <div className="flex flex-wrap items-center gap-1">
          ...
          <ToolbarButton label="Bold" icon={Bold} onClick={() => format('bold', true)} />
          <ToolbarButton label="Italic" icon={Italic} onClick={() => format('italic', true)} />
          <ToolbarButton label="Underline" icon={Underline} onClick={() => format('underline', true)} />
          <ToolbarButton label="Strike" icon={Strikethrough} onClick={() => format('strike', true)} />
          <Separator orientation="vertical" className="mx-1 h-6" />

          <ToolbarButton label="Ordered List" icon={ListOrdered} onClick={() => format('list', 'ordered')} />
          <ToolbarButton label="Bullet List" icon={List} onClick={() => format('list', 'bullet')} />
          <ToolbarButton label="Blockquote" icon={Quote} onClick={() => format('blockquote', true)} />
          <ToolbarButton label="Code Block" icon={Code} onClick={() => format('code-block', true)} />
          <Separator orientation="vertical" className="mx-1 h-6" />

          <ToolbarButton label="Insert Link" icon={LinkIcon} onClick={insertLink} />
          ...
          <ToolbarButton label="Clear Formatting" icon={Eraser} onClick={() => format('clean', true)} />
      ...
      <CardFooter className="flex justify-between text-xs text-muted-foreground">
        <span>Supports images with alt, embeds, lists without empty bullets, and cleanup.</span>
